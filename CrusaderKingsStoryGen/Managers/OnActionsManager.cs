// <copyright file="OnActionsManager.cs" company="Yemmlie - 252afh fork">
...
namespace CrusaderKingsStoryGen.Managers
{
    ...
    class OnActionsManager
    {
        ...
        public void Load()
        {
            this.script = ScriptLoader.instance.Load(Globals.GameDir + "common\\on_actions\\00_on_actions.txt");

            this.removals.Add("on_character_switch_society_interest");
            this.removals.Add("on_character_ask_to_join_society");
