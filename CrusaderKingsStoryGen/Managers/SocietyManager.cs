// <copyright file="SocietyManager.cs" company="Yemmlie - 252afh fork">
...
namespace CrusaderKingsStoryGen.Managers
{
    ...
    partial class SocietyManager
    {
        ...
        {
            var lang = StarHelper.Generate(c);

            switch (RandomIntHelper.Next(5))
            {
                case 0:
                    lang = "The " + lang + " Order";
                    break;
            ...
            var temp = this.Societies[template.ToString()];
            this.Societies[name] = newSociety;
        ...
        */
        ...
        public void Load()
        {
            ...
            foreach (var file in files)
            {
                ...
                for (int index = 0; index < s.Root.Children.Count; index++)
                {
                    ...
                    this.Societies[(sc as ScriptScope).Name] = sc as ScriptScope;
                }
        ...
        public void Save()
        {
            ...
            for (int index = 0; index < this.Scripts.Count; index++)
            {
                ...
                foreach (var c in this.Scripts[0].Root.Children)
                {
