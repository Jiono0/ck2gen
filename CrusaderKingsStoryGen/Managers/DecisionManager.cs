// <copyright file="DecisionManager.cs" company="Yemmlie - 252afh fork">
       ...
       public static DecisionManager instance = new DecisionManager();
        ...
        public void Save()
        {
            ...
            foreach (var script in this.Scripts)
            {
                ...
                {
                    this.ExporeDecisions(script.Root.Children[0] as ScriptScope);
                    this.ConvertReligionTests(script.Root);
                    script.Save();
                }
            }
        ...
        private void RemoveAllReligionTests(ScriptScope node)
        {
            for (int index = 0; index < node.Children.Count; index++)
            {
                ...
                if (child is ScriptScope)
                {
                    this.RemoveAllReligionTests(child as ScriptScope);
                }
        ...
        public void SearchReplace(ScriptScope node, Dictionary<string, string> searchReplace, string prefix)
        {
            ...
            for (int index = 0; index < node.Children.Count; index++)
            {
                ...
                if (child is ScriptScope)
                {
                    this.SearchReplace(child as ScriptScope, searchReplace, prefix);
                }
        ...
        public void Correct(ScriptScope node, Dictionary<string, string> searchReplace, string prefix)
        {
            ...
            for (int index = 0; index < node.Children.Count; index++)
            {
                ...
                if (child is ScriptScope)
                {
                    this.Correct(child as ScriptScope, searchReplace, prefix);
                }
        ...
        private void ConvertReligionTests(ScriptScope node)
        {
            for (int index = 0; index < node.Children.Count; index++)
            {
                ...
                if (child is ScriptScope)
                {
                    this.ConvertReligionTests(child as ScriptScope);
                }
            ...
            Dictionary<string, string> convert)
        {
            ...
            this.SearchReplace(s.Root, convert, prefix);

            s.Save();
            this.Correct(s.Root, convert, prefix);
        }
    }
}
