// <copyright file="TitleManager.cs" company="Yemmlie - 252afh fork">
...
namespace CrusaderKingsStoryGen.Managers
{
    ...
    class TitleManager : ISerializeXml
    {
        ...
        {
            this.LandedTitlesScript = ScriptLoader.instance.Load(
                Globals.GameDir + "common\\landed_titles\\landed_titles.txt");

            foreach (var child in this.LandedTitlesScript.Root.Children)
            {
                this.DoVanillaTitle(child as ScriptScope, null);
        ...
        public void Load()
        {
            ...
            this.LandedTitlesScript.Root.Clear();
            /*
       ...
       //     RemoveDukeAndAbove();
        ...
        {
            var array = this.TieredTitles.Values.ToArray();
        }
        ...
        private void PromoteAllToTop()
        {
            ...
            foreach (var titleParser in array)
            {
                foreach (var subTitle in titleParser.SubTitles)
                {
                    ...
                    this.PromoteToTop(subTitle.Value);
                }
            }

            foreach (var titleParser in this.toTop)
            {
                this.LandedTitlesScript.Root.Add(titleParser.Scope);
                titleParser.Scope.Parent = this.LandedTitlesScript.Root;
                this.TieredTitles[titleParser.Name] = titleParser;
            }
        }
        ...
        private bool PromoteToTop(TitleParser title)
        {
            ...
            this.toTop.Add(title);
            return true;
        }

        public void Save()
        {
            this.LandedTitlesScript.Root.Strip(new string[]
            {
                "layer",
                "pagan_coa"
            });
        ...
        public void CreateMercs()
        {
            ...
            foreach (var cultureParser in CultureManager.instance.AllCultures)
            {
                ...
                this.LandedTitlesScript.Root.Do(@"
        ...
        {
            if (capital.ProvinceTitle == "c_keysay")
            {
            }
            ...
            scope.Parent = this.LandedTitlesScript.Root;

            if (name == null)
            {
                string place = capital.Title.Holder.Culture.dna.GetPlaceName();
                string text = place;
                place = StarHelper.SafeName(place);


                if (TitleManager.instance.TitleMap.ContainsKey("d_" + place))
                {
                    return this.CreateDukeScriptScope(capital, name);
                }
            ...
            else
            {
                ...
                {
                    return this.CreateDukeScriptScope(capital);
                }
            }
...
//                title.Scope.Do("historical_nomad = yes");
        ...
        public TitleParser CreateDukeScriptScope(ProvinceParser capital, CharacterParser chr)
        {
...

            {
                ...
                if (TitleManager.instance.TitleMap.ContainsKey("d_" + place))
                {
                    return this.CreateDukeScriptScope(capital, chr);
                }
...
//                title.Scope.Do("historical_nomad = yes");
        ...
        public TitleParser CreateBaronyScriptScope(ProvinceParser capital, CultureParser culture)
        {
            ...
            var text = place;
            place = StarHelper.SafeName(text);

            if (TitleManager.instance.TitleMap.ContainsKey("b_" + place))
            {
                return this.CreateBaronyScriptScope(capital, culture);
            }
            ...
            {
                this.LandedTitlesScript.Root.Add(title.Scope);
            }
        ...
        public TitleParser CreateKingScriptScope(ProvinceParser capital, CharacterParser chr)
        {
...

            {
                ...
                {
                    return this.CreateKingScriptScope(capital, chr.culture);
                }
        ...
        public void AddTitle(TitleParser title)
        {
            ...
            this.TieredTitles[title.Name] = title;
            this.LandedTitlesScript.Root.Add(title.Scope);
            title.Scope.Parent = this.LandedTitlesScript.Root;

            title.color = Color.FromArgb(255, RandomIntHelper.Next(255), RandomIntHelper.Next(255), RandomIntHelper.Next(255));
        ...
        public void SaveTitles()
        {
            foreach (var titleParser in this.Titles)
            {
                ...
                if (!bFound && p.Count > 0)
                {
                    var ca = p[RandomIntHelper.Next(p.Count)];
...
"
        ...
        {
            TitleParser s = this.CreateEmpireScriptScope(capital);
        ...
        public ProvinceParser GetRandomCount()
        {
            ...
            return list[RandomIntHelper.Next(list.Count)].CapitalProvince;
        }
        ...
        public void SaveProject(XmlWriter writer)
        {
            ...
            foreach (var rootChild in this.LandedTitlesScript.Root.Children)
            {
                        ...
                        foreach (var scopeChild in scope.Children)
                        {
                            ...
                            if (com.Name == "liege")
                            {
                                if (com.Value.ToString() != "0")
                                {
                                    ...
                                    {
                                        titleParser.LiegeDirect = this.TitleMap[com.Value.ToString()];
                                    }
                                }
                                else
                                {
